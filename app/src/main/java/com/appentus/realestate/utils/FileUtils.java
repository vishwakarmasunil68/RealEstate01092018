...
public class FileUtils {
    public static String BASE_FILE_PATH = Environment.getExternalStorageDirectory().toString() + File.separator + "aquar";
    ...
    public static String getPhotoFolder() {
        File f = new File(getBaseFilePath() + File.separator + "photo");
        if (!f.exists()) {
            f.mkdirs();
        }
