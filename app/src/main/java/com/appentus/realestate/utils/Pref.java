...
public class Pref {
    ...
    private static final String PrefDB = "aquar";
    private static final String PerPrefDB = "peraquar";
    ...
    public static void SaveDeviceToken(Context context, String Value) {
        SharedPreferences sp = context.getSharedPreferences("kaajneetidevicetoken.txt", MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
